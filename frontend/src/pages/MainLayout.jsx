      ...
      <main className="flex-1 flex flex-col overflow-y-auto bg-[var(--app-surface)] relative z-10">
        <header className="flex items-center justify-between px-6 lg:px-8 py-4 border-b border-[var(--panel-border)] bg-[var(--panel)]/80 backdrop-blur-md sticky top-0 z-30">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-lg lg:text-xl font-bold tracking-tight text-[var(--app-foreground)]">Heureux de vous revoir, Christian !</h2>
              <p className="text-xs text-[var(--muted-foreground)] hidden sm:block">Distribution et déploiement des kits solaires par province en RDC</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <div className="relative w-40 sm:w-64 hidden md:block">
              ...
              <Input 
                ...
                className="pl-9 bg-[var(--panel-alt)] border-[var(--panel-border)] text-[var(--app-foreground)] placeholder:text-[var(--muted-foreground)] focus-visible:ring-1 focus-visible:ring-[#FF7900] rounded-xl transition-all" 
              />
            </div>
